 ...
 * @author Waqar
 */
public class MekaRankingNodePlugin extends Plugin {
    // The shared instance.
    private static MekaRankingNodePlugin plugin;

    /**
     * The constructor.
     */
    public MekaRankingNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MekaRankingNodePlugin getDefault() {
        return plugin;
    }
